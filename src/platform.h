/** @file platform.h
 *  @author T J Atherton, modified ever so slightly by Robi Jenik
 *
 *  @brief Isolates platform dependent code in morpho, changed to use
 *         the C++/C compatible complex<double> instead of platform-specific C
 *         complex extensions
*/
...
typedef std::complex<double> MorphoComplex;
// ^ the Robi addition
